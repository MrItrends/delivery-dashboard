...
export const ENTITIES: Record<string, EntityConfig> = {
  ...
  intervention: {
    ...
    fields: [
      { name: 'ref', label: 'Ref', type: 'text', placeholder: 'e.g. 1.1' },
      { name: 'name', label: 'Name', type: 'text', placeholder: 'e.g. Indigenous chicken farming', required: true },
      { name: 'owner', label: 'Lead', type: 'text' },
      { name: 'co_lead', label: 'Co-Lead', type: 'text' },
