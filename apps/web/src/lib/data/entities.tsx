...
export const ENTITIES: Record<string, EntityConfig> = {
  ...
  priorityArea: {
    ...
    fields: [
      { name: 'name', label: 'Name', type: 'text', placeholder: 'e.g. Hospital Estate Renewal', required: true },
      { name: 'mission', label: 'Mission', type: 'textarea', placeholder: 'The strategic objective this priority area delivers.' },
      { name: 'owner', label: 'Owner', type: 'text', placeholder: 'e.g. Ahmed Yusuf' },
      { name: 'health', label: 'Overall health', type: 'select', options: HEALTH_OPTIONS },
      { name: 'budget_health', label: 'Budget health', type: 'select', options: HEALTH_OPTIONS },
  ...
  project: {
    ...
    fields: [
      { name: 'name', label: 'Name', type: 'text', placeholder: 'e.g. Ward 4 Reconstruction', required: true },
      { name: 'description', label: 'Description', type: 'textarea' },
      { name: 'owner', label: 'Owner', type: 'text' },
  ...
  intervention: {
    ...
    fields: [
      { name: 'name', label: 'Name', type: 'text', placeholder: 'e.g. Structural Works', required: true },
  ...
  activity: {
    ...
    fields: [
      { name: 'name', label: 'Title', type: 'text', placeholder: 'e.g. Confirm steel delivery schedule', required: true },
      { name: 'description', label: 'Description', type: 'textarea' },
      { name: 'owner', label: 'Owner', type: 'text' },
      ...
      { name: 'due_label', label: 'Due', type: 'text', placeholder: 'e.g. Today, In 3 days' },
